  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-96 h-96 bg-indigo-500/20 dark:bg-indigo-500/10 rounded-full blur-[100px]"></div>
      </div>
      ...
      >
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[2rem] shadow-2xl dark:shadow-none border border-gray-200/50 dark:border-gray-800 p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">Enter your details to access insights.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full flex justify-center items-center gap-2 py-3 px-4 mt-6 border border-transparent rounded-xl shadow-md text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all hover:-translate-y-0.5"
            >
